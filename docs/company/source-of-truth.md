...
### Perfil ideal
- 1 a 5 pessoas no atendimento e vendas
- 50 conversas/dia em rotina normal, com picos de 150 em promoções
- Dono(a) envolvido(a) diretamente na operação
- Vendas de pronta entrega e/ou encomenda

### Dores priorizadas
1. Mensagens se perdem e clientes ficam sem resposta
2. Falta de follow-up após o primeiro contato
3. Desorganização de pedidos (pagamento, retirada, entrega, encomendas)
4. Atendimento sem padrão
5. Falta de priorização do que está quente no funil

## 3) Oferta principal de entrada
### Formato
Implantação guiada em até 14 dias.

### Entrega mínima
- Mapeamento de etapas e responsabilidades
- Playbooks de atendimento e rotina
- Configuração de automações iniciais
- Painel simples de acompanhamento

### Escopo inicial
- 1 canal principal
- 1 processo crítico por cliente
...
### Atendimento e vendas (específica)
...
3. Referenciar a issue ou decisão que motivou a mudança.
